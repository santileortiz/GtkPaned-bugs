//gcc separator_vanishes_fix.c -o separator_vanishes_fix `pkg-config --cflags --libs gtk+-3.0`
/*
...
// This new fix improves on the old one by avoiding the use of a negative
// margin, which stops the separator from vanishing.
